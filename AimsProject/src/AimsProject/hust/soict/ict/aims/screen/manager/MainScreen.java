...
public class MainScreen {
    public static void main(String[] args) {
        ...
        store.addMedia(dvd8);
        DigitalVideoDisc dvd11 = new DigitalVideoDisc(8, "The Lion King 5", "Animation", 19.66f, 99, "Roger Allers");
        ...
        CompactDisc cd9 = new CompactDisc(9, "Star Wars 3", "Science Friction", 18.9f);
        ...
        Book book10 = new Book(10, "Aladin 3", "Animation", 15.2f, "Author 4");
        Book book12 = new Book(12, "Aladin 4", "Animation", 15.2f, "Author 2");
        Book book13 = new Book(13, "Aladin 5", "Animation", 15.2f, "Author 1");
